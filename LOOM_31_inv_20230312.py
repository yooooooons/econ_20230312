...
ma_duration_mid = 40   # 중기 ma 산출 기간
ma_duration_long = 60   # 장기 ma 산출 기간
...
def DF_mv (DF_mv_target) :
    ...
    DF_mv_ratget['ratio_ema_Not_buy_check'] = DF_mv_target['ema_Not_buy_check'] / DF_mv_target['ema_Not_buy_check'].shift(3)
